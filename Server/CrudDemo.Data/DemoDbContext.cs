...
namespace CrudDemo.Data
{
    ...
    {        
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var systemEmloyee = new EmployeeEntity
            {
                EmployeeId = Guid.NewGuid(),
                FirstName = "System",
                LastName = "System",
                BirthDate = new DateTime(1972, 03, 14),
                DepartmentCode = "SUP",
                Email = "",
                PhoneNumber = ""
            };
            modelBuilder.Entity<EmployeeEntity>()
                .HasData(
                    ...
                    new EmployeeEntity
                    {
                        ...
                        FirstName = "Bus",
                        LastName = "Lightyear",
                        BirthDate = new DateTime(1980, 04, 1),
                        DepartmentCode = "ENG",
                    ...
                    new EmployeeEntity
                    {
                        ...
                        FirstName = "Robert",
                        LastName = "Goddard",
                        BirthDate = new DateTime(1985, 01, 2),
                        DepartmentCode = "RKT",
            ...
            modelBuilder.Entity<ProjectEntity>()
                .HasData(
                    new ProjectEntity
                    {
                        ...
                        CreatedByEmployeeId = systemEmloyee.EmployeeId
                    },
                    new ProjectEntity
                    {
                        ProjectId = Guid.NewGuid(),
