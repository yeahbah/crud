...
namespace CrudDemo.Web.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        {
            await this.mediator.Send(new DeleteProjectCommand(id), cancellationToken);
            return NoContent();
        }
        ...
        {
            await this.mediator.Send(new UpdateProjectCommand(projectUpdateDto), cancellationToken);
            return NoContent();
        }
    }
}
