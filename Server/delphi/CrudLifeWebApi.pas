...
type
  TCrudLifeWebModule = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TCrudLifeWebModule;
...
procedure TCrudLifeWebModule.WebModuleCreate(Sender: TObject);
begin
...
procedure TCrudLifeWebModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
